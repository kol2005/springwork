...
public class ProductService {
	...
	public List<ProductDTO> findByNameAndPagenation(String p_name, PageDTO pageDTO) {
		
		List<String> p_names = Arrays.asList(p_name.split(" "));
		return proDao.findByPNameListAndPagenation(p_names,pageDTO);
	}
	
	
	public List<ProductDTO> selectPageNation(PageDTO pageDTO) {
		List<ProductDTO> proDTOList = proDao.selectPagenation(pageDTO);
		return proDTOList;
	}
