...
$(function(){
	...
	// 표준함수 선언 방식
	function idcheck(){
		//let top = (window.screen.availTop + (window.screen.availHeight / 2)) - (window.screen.height / 2)
		let top = 500
		//let left = (window.screen.availLeft + (window.screen.availWidth / 2)) - (window.screen.width / 2)
		let left = 500
...
<button type="button" id="id_check">아이디 검사</button><br/>
